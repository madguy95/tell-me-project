<template>
  <div class="">
    <b-card>
      <b-row>
        <b-col md="8">
          <div class="panzoom-container" v-viewer="{ movable: false, rotatable: false, scalable: false }">
        ...
        <b-col md="4">
          <b-list-group>
            ...
            >
              <b-icon :icon="isOpen(index) ? 'chevron-up' : 'chevron-down'" class="mr-2"></b-icon>
              {{ item.name }}
              <b-collapse v-model="openItems[index]">
                <b-list-group>
                  ...
                  >
                    <b-icon :icon="isOpenSub(index, subIndex) ? 'chevron-up' : 'chevron-down'" class="mr-2"></b-icon>
                    {{ subItem.name }}
                    <b-collapse v-model="openItemsSub[index][subIndex]">
                      <b-list-group>
                        <b-list-group-item v-for="(subSubItem, subSubIndex) in subItem.rooms" :key="subSubIndex">
                          {{ subSubItem.name }}
                        </b-list-group-item>
                      </b-list-group>
                    </b-collapse>
      ...
      items: [
        ...
        },
        {
          ...
          floors: [
            ...
            {
              name: 'Tầng 2',
              rooms: ['Khoa Ngoại Tai Mũi Họng', 'Khoa Ngoại Thần Kinh', 'Khoa Ngoại tổng hợp Quán Sứ']
            },
            {
              name: 'Tầng 3',
              rooms: ['Khoa Nội 1', 'Khoa Nội nhi', 'Khoa Ngoại đầu cổ (Ngoại A)', 'Khoa Xạ đầu cổ (Xạ 1)']
            },
            {
              name: 'Tầng 4',
              rooms: [
            ...
            {
              name: 'Tầng 5',
              rooms: ['Khoa Nội ', 'Khoa Xạ 5', 'Khoa Ngoại bụng 1', 'Khoa Ngoại bụng 2']
            },
            {
              name: 'Tầng 6',
              rooms: ['Khoa Nội 3', 'Khoa Nội 6', 'Khoa Ngoại tiết niệu', 'Khoa Ngoại Lồng ngực (ngoại D)']
            },
            {
              name: 'Tầng 7',
              rooms: ['Khoa Nội 2', 'Khoa Ngoại gan mật tụy', 'Khoa điều trị A']
            }
          ]
        },
        {
          ...
          floors: [
            ...
            {
              name: 'Tầng 2',
              rooms: ['Trung tâm dinh dưỡng Lâm Sàng', 'Căn tin cán bộ nhân viên', 'Khoa Kiểm soát nhiễm khuẩn']
            }
          ]
        }
      ],
  ...
  methods: {
    ...
    toggleSub(index, subIndex) {
      if (this.openItemsSub[index][subIndex] !== undefined) {
        this.$set(this.openItemsSub[index], subIndex, !this.openItemsSub[index][subIndex])
      } else {
        this.$set(this.openItemsSub[index], subIndex, true)
      }
    },
    isOpen(index) {
      return this.openItems[index] !== undefined ? this.openItems[index] : false
    },
    isOpenSub(index, subIndex) {
      return this.openItemsSub[index] && this.openItemsSub[index][subIndex] !== undefined
