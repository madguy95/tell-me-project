<template>
  <div class="container-fluid bg-white position-relative pt-3 pb-3">
    ...
    <div>
      <h1 class="text-center text-title">Vui lòng nhập thông tin trước khi làm bài khảo sát.</h1>
      <h4 class="sub-note mt-2">
        Những thông tin này nhằm mục đích thống kê và sàng lọc kết quả, phục vụ mục đích y tế, không sử dụng cho các mục
        đích khác nhằm đảm bảo thông tin của người dùng.
      </h4>
    </div>
    <b-form>
      <b-form-group label="" label-for="checkbox-group">
        ...
        <b-form-group v-slot="{ ariaDescribedby }">
          <b-form-radio v-model="tester.gender" :aria-describedby="ariaDescribedby" name="some-radios" value="M"
            >Nam</b-form-radio
          >
          <b-form-radio v-model="tester.gender" :aria-describedby="ariaDescribedby" name="some-radios" value="F"
            >Nữ</b-form-radio
          >
        </b-form-group>
      </b-form-group>
    </b-form>
    <b-button class="button-start text-center" @click="clickNext" :disabled="!isValid">
