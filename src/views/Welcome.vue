<template>
  ...
  >
    ...
    <b-row class="">
      <b-col>
        <h3 class="mt-3 welcome-text">Chào mừng bạn đến với website dự án!</h3>
      </b-col>
    </b-row>
    <b-row class="">
      <h1 class="mt-3 project-name">Tell me</h1>
    </b-row>
    <b-row class="">
      <b-col>
    ...
    <b-row class="">
      ...
      <!-- <b-form-group label="" class="mt-3">
        <b-form-select class="select-box-bv custom-select" v-model="selected" @change="onChangeSelectBox"
          :options="options">
          <template #first>
            <b-form-select-option :value="null" disabled>Chọn Bệnh viện</b-form-select-option>
          </template>
...
.img-container {
  ...
  height: 380px;
  overflow: hidden;
  /* Ẩn phần ảnh vượt ra ngoài kích thước */
  position: relative;
  /* Đặt vị trí cho ảnh bên trong */
  display: flex;
...
.img-container img {
  width: 100%;
  /* Ảnh sẽ chiếm toàn bộ chiều rộng của div */
  height: 100%;
  /* Ảnh sẽ chiếm toàn bộ chiều cao của div */
  object-fit: cover;
  /* Ảnh sẽ được cắt sao cho vừa với div, giữ tỷ lệ khung hình */
}
